    ...
    return (
        <div className="space-y-6 p-6">
            <HeadingCard
                ...
                subtitle="Complete information about the medicine"
                breadcrumbItems={[
                    { label: "Home", url: "/" },
                ...
                <CardContent sx={{ p: 3 }}>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 3 }}>
                        ...
                        <Button
                            variant="contained"
                            startIcon={<EditIcon />}
                            onClick={() => navigate(`/pharmacist/medicines/edit/${id}`)}
                            sx={{
                                ...
                                {daysUntilExpiry !== null && (
                                    <Grid item xs={12} sm={6}>
                                        <DetailItem
                                            ...
                                            value={daysUntilExpiry > 0 ? `${daysUntilExpiry} days` : daysUntilExpiry === 0 ? "Expires Today" : `Expired ${Math.abs(daysUntilExpiry)} days ago`}
                                ...
                                {medicine.createdBy && (
                                    <Grid item xs={12} sm={6}>
                                        <DetailItem
                                            ...
                                            label="Created By"
                                            value={typeof medicine.createdBy === 'object' ? medicine.createdBy.name || medicine.createdBy.email || 'N/A' : 'N/A'}
                                        />
                                    </Grid>
                                )}
                                {medicine.updatedBy && (
                                    <Grid item xs={12} sm={6}>
                                        <DetailItem
                                            icon={<PersonIcon fontSize="small" />}
                                            label="Updated By"
                                            value={typeof medicine.updatedBy === 'object' ? medicine.updatedBy.name || medicine.updatedBy.email || 'N/A' : 'N/A'}
                                        />
                                    </Grid>
                                )}
                            </Grid>
