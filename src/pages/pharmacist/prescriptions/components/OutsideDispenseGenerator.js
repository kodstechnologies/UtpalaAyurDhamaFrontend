                ...
                <div class="info-container">
                  <div class="patient-box">
                    <table class="info-table">
                      ...
                      <tr><td class="label">Alternative No.</td><td>:</td><td>${escapeHtml(customer.alternativePhone) || "N/A"}</td></tr>
                      <tr><td class="label">Email</td><td>:</td><td>${escapeHtml(customer.email) || "N/A"}</td></tr>
                      <tr><td class="label">Address</td><td>:</td><td>${escapeHtml(customer.address) || "N/A"}</td></tr>
