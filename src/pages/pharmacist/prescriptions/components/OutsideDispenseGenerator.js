                ...
                <div class="info-container">
                  <div class="patient-box">
                    <table class="info-table">
                      ...
                      <tr><td class="label">Age</td><td>:</td><td>${customer.age !== "" && customer.age != null ? escapeHtml(String(customer.age)) : ""}</td></tr>
                      <tr><td class="label">Phone</td><td>:</td><td>${escapeHtml(customer.phone)}</td></tr>
                      <tr><td class="label">Alternative No.</td><td>:</td><td>${escapeHtml(customer.alternativePhone)}</td></tr>
                      <tr><td class="label">Email</td><td>:</td><td>${escapeHtml(customer.email)}</td></tr>
                      <tr><td class="label">Address</td><td>:</td><td>${escapeHtml(customer.address)}</td></tr>
                      <tr><td class="label">Disease</td><td>:</td><td>${escapeHtml(customer.disease)}</td></tr>
