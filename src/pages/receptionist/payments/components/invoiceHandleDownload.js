...
const invoiceHandleDownload = async (invoice, options = {}) => {
  ...
  try {
    ...
    const receiptDetailsRows = `
              <tr>
                <td style="font-weight:bold; width:45%; padding:2px 0;">Invoice No</td>
                <td style="padding:2px 0;">: ${escapeHtml(invoiceNo)}</td>
              </tr>
              <tr>
                <td style="font-weight:bold; padding:2px 0;">Date / Time</td>
                <td style="padding:2px 0;">: ${escapeHtml(receiptDateTime)}</td>
              </tr>
              <tr>
                <td style="font-weight:bold; padding:2px 0;">Status</td>
                <td style="padding:2px 0; vertical-align:middle;">: <span style="background-color:#e8e8e8; color:#000; font-weight:600; font-size:11px; border-radius:3px; display:inline-block; line-height:1.3; padding:0px 8px; height:1.3rem;">${paymentStatus}</span></td>
              </tr>
              <tr>
                <td style="font-weight:bold; padding:2px 0;">Type</td>
                <td style="padding:2px 0;">: ${invoice.inpatient ? "IN-PATIENT" : invoice.examination?.isDaycare ? "DAYCARE" : "OUT-PATIENT"}</td>
              </tr>
              ${invoice.referredBy ? `
              <tr>
                <td style="font-weight:bold; padding:2px 0;">Referred By</td>
                <td style="padding:2px 0;">: ${escapeHtml(invoice.referredBy)}</td>
              </tr>
              ` : ""}
              ${invoice.consultedBy ? `
              <tr>
                <td style="font-weight:bold; padding:2px 0;">Consulted By</td>
                <td style="padding:2px 0;">: ${escapeHtml(invoice.consultedBy)}</td>
              </tr>
              ` : ""}
              <tr>
                <td style="font-weight:bold; padding:2px 0;">Generated By</td>
                <td style="padding:2px 0;">: ${escapeHtml(receptionistName || "N/A")}</td>
              </tr>
      `;
    ...
    const infoSectionHtml = `
      <div style="width:794px; box-sizing:border-box; padding:0 15px; font-family:Arial, Helvetica, sans-serif; color:#000; background:#fff;">
        <div style="display:flex; border:1px solid #000; margin:1px 0 0 0; height:100%">
          <div style="width:60%; border-right:1px solid #000;">
            ...
            <div style="background:#fafafa; padding:3px 0 3px 0px;">
            <table style="width:100%; height:10rem; margin:5px; font-size:12px; border-collapse:collapse; line-height:1.25;">
              <tr><td style="font-weight:bold; width:100px; padding:0;">NAME</td><td style="padding:0;">:</td><td style="padding:0;">${escapeHtml(patient.name)}</td></tr>
              <tr><td style="font-weight:bold; padding:0;">AGE</td><td style="padding:0;">:</td><td style="padding:0;">${escapeHtml(formattedAge)}</td></tr>
              <tr><td style="font-weight:bold; padding:0;">GENDER</td><td style="padding:0;">:</td><td style="padding:0;">${escapeHtml(patient.gender)}</td></tr>
              ${patient.address && patient.address !== "N/A" ? `<tr><td style="font-weight:bold; padding:0;">ADDRESS</td><td style="padding:0;">:</td><td style="padding:0;">${escapeHtml(patient.address)}</td></tr>` : ""}
              ${patient.phone && patient.phone !== "N/A" ? `<tr><td style="font-weight:bold; padding:0;">PHONE</td><td style="padding:0;">:</td><td style="padding:0;">${escapeHtml(patient.phone)}</td></tr>` : ""}
              ${patient.alternativeNumber ? `<tr><td style="font-weight:bold; padding:0;">ALT. NO</td><td style="padding:0;">:</td><td style="padding:0;">${escapeHtml(patient.alternativeNumber)}</td></tr>` : ""}
              <tr><td style="font-weight:bold; padding:0;">UHID NO</td><td style="padding:0;">:</td><td style="padding:0;">${escapeHtml(patient.uhid)}</td></tr>
              <tr><td style="font-weight:bold; padding:0;">PATIENT ID</td><td style="padding:0;">:</td><td style="padding:0;">${escapeHtml(patient.patientId)}</td></tr>
              <tr><td style="font-weight:bold; padding:0;">E-MAIL</td><td style="padding:0;">:</td><td style="padding:0;">${escapeHtml(patient.email || "_")}</td></tr>
             ${doctorName !== "N/A"
        ? `<tr>
       <td style="font-weight:bold; padding:0;">DOCTOR</td>
       <td style="padding:0;">:</td>
       <td style="padding:0;">${escapeHtml(
        ...
        : ""}
          ...
          <div style="width:40%;">
            ...
            <div style="background:#fafafa; padding:3px 0 3px 3px;">
    ...
    layoutPdfSections({
      ...
      brownFooterH,
      notesSectionH,
      categoryCount: categoryCanvases.length,
      pdfH,
      pdfW,
      margin,
      contentW,
