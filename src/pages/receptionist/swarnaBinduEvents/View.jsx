    ...
    const actions = [
        {
            ...
            onClick: (row) => navigate(`/receptionist/swarna-bindu-events/edit/${row._id}`),
        },
        {
        ...
        <Box sx={{ p: 3 }}>
            <HeadingCard
                ...
                action={
                    <RedirectButton
                        text="View Calendar"
                        link="/receptionist/swarna-bindu-events/calendar"
            ...
            >
                ...
                <Box sx={{ display: "flex", gap: "1rem" }}>
                    ...
                    />
                    <RedirectButton text="Create Event" link="/receptionist/swarna-bindu-events/add" />
                </Box>
            </CardBorder>
