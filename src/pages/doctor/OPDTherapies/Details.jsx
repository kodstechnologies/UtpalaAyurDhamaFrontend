...
function OPDTherapyDetails() {
        ...
        const fetchTherapyPlan = async () => {
            ...
            try {
                const response = await axios.get(
                    getApiUrl(`examinations/therapy-plans/opd/${id}`),
    ...
    return (
        <Container maxWidth="lg" sx={{ py: 3 }}>
            <HeadingCard
                title="OPD Therapy Plan Details"
            ...
            <Box sx={{ mt: 3, mb: 3, display: "flex", gap: 2, flexWrap: "wrap" }}>
                <Button
                    ...
                    onClick={() => navigate("/doctor/opd-therapies")}
                    sx={{
                ...
                <Button
                    variant="contained"
                    startIcon={<EditIcon />}
                    onClick={() => navigate(`/doctor/opd-therapies/edit/${id}`)}
                    sx={{
...
export default OPDTherapyDetails;
